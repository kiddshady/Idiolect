/* ═══════════════════════════════════════════════════════════════════════════
   IDIOLECT — publicar un release entero, o no publicar nada
...
const PIE = 'Se instala sola si ya tenés Idiolect. Si es tu primera vez, Windows SmartScreen va a advertir porque el instalador no está firmado.';
