...
const P = {
  /* ── Identidad ─────────────────────────────────────────────────────────────
     La marca de Idiolect: un globo de diálogo con una virgulilla adentro, la
     rayita de la ñ. La clave sigue siendo `onyx` porque el shell la busca por
     ese nombre; tiene que coincidir con el splash de index.html. */
  onyx: '<path d="M3.6 2.6h8.8A1.6 1.6 0 0 1 14 4.2v5.4a1.6 1.6 0 0 1-1.6 1.6H7.4l-3 2.6v-2.6h-.8A1.6 1.6 0 0 1 2 9.6V4.2a1.6 1.6 0 0 1 1.6-1.6z"/>'
      + '<path class="ox-brand__trail" d="M5.1 7.3c.9-1.1 1.9-1.1 2.9-.3s2 .8 2.9-.3"/>',
